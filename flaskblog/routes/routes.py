...
from flaskblog.forms import (RegistrationForm, LoginForm, UpdateAccountForm, 
                             ...
                             ClienteForm, ClienteUpdateForm)
from flaskblog.models import User, Post, Cliente, TipoCliente, Contactos
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash('Your pass has been update! You are now able to log in', 'success')
        return redirect(url_for('login'))
